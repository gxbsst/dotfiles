...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-spectre', 'gitsigns.nvim', 'Comment.nvim', 'git-blame.nvim', 'diffview.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
